...
| **Varlık**  | USDC. Arc'ta hem gas token'ı hem gönderdiğiniz şey. Gizli ödemeler EURC ile de yapılabilir; gaz yine USDC'den gider |
...
| **Testler** | Toplam 649: 114 Foundry, 360 SDK, 86 demo-kit, 56 api, 33 keeper, artı canlı testnet koşuları |
