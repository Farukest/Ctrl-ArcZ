...
export const tr: Record<TranslationKey, string> = {
  ...
  'nano.lead': "Her isteği ajan, Gateway'deki bakiyesinden Circle Nanopayments ile öder. Gaz yok, aylık fatura yok.",
  ...
  'nano.step.deposit': "Ajan için Gateway'e yatırma",
