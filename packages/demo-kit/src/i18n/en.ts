...
export const en = {
  ...
  'nano.title': 'Pay per request',
  'nano.lead': 'The agent pays each request from its Gateway balance with a Circle Nanopayment. No gas, no monthly bill.',
  'nano.activate': 'Activate',
  'nano.left': 'Balance',
  'nano.perRequest': 'Per request',
  'nano.requestsLeft': 'Requests left',
  'nano.spent': 'Spent',
  'nano.agent': 'Agent wallet',
  'nano.statusOk': 'Healthy',
  'nano.statusWarn': 'Running low',
  'nano.statusCritical': 'Critical',
  'nano.statusEmpty': 'Empty',
  'nano.loadTitle': 'Load budget',
  'nano.load': 'Load to Gateway',
  'nano.step.approve': 'Approve USDC',
  'nano.step.deposit': 'Deposit to Gateway for the agent',
  'nano.step.credit': 'Circle credits the balance',
  'nano.loadedToast': 'Budget loaded.',
  'nano.accessTitle': 'Your API',
  'nano.baseUrl': 'API URL',
  'nano.apiKey': 'API Key',
  'nano.tryPh': 'Ask Claude something',
  'nano.try': 'Send',
  'nano.feedTitle': 'Requests',
  'nano.feedEmpty': 'No requests yet.',
  'nano.paidToast': 'Payment received · {amount}',
  'nano.tokens': '{in} in · {out} out',
  'nano.circle.pending': 'Circle: pending',
  'nano.circle.received': 'Circle: received',
  'nano.circle.batched': 'Circle: batched',
  'nano.circle.completed': 'Circle: settled',
  'nano.circle.failed': 'Circle: failed',
  'nano.withdraw': 'Withdraw the rest',
  'nano.withdrawnToast': '{amount} is on its way to your wallet.',
