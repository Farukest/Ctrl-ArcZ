...
How to integrate `@ctrl-arcz/sdk`. The SDK itself is headless (no UI), so these show
...
| [`apps/sender`](../apps/sender) | A React + Vite app | See a complete **web UI** integration: wallet connect, the live firewall on the recipient field, protected send, code-gated claim, cancel/refund, gasless claim, i18n, dark/light. This is the reference "example website." |
