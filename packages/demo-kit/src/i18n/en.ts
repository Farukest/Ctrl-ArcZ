...
export const en = {
  ...
  'sub.cap': 'Total budget (USDC)',
  'sub.capTooLow': 'Budget must be at least one pull',
  'sub.interval': 'Interval',
  'sub.duration': 'Valid for',
  ...
  'claim.saltHint': 'Comes from the claim link. Paste it here if you were given it directly.',
