...
export const en = {
  ...
  'bridge.title': 'Bridge USDC (CCTP)',
  'bridge.body': 'Move USDC across chains with Circle CCTP.',
  'bridge.point1': 'Burned on the source chain, minted on the destination.',
  'bridge.point2': 'Circle attestation authorizes the mint once the burn is final.',
  'bridge.point3': 'Circle sponsors the destination mint, so you need no gas there.',
  'bridge.from': 'From',
  'bridge.to': 'To',
  'bridge.searchChain': 'Search network',
  'bridge.sameChain': 'Choose two different chains.',
  'bridge.amount': 'Amount (USDC)',
  'bridge.feeNote': 'A small CCTP fast-transfer fee applies, so the amount must exceed it.',
