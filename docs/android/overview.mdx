...
>
  <Frame caption="Confirming a send">
    <img src="/android/send-confirm.png" alt="Confirming a send on Android" />
  </Frame>
  <Frame caption="Picking a merchant">
    <img src="/android/merchant-picker.png" alt="Picking a merchant on Android" />
  </Frame>
  <Frame caption="A bridge transfer returned">
    <img src="/android/bridge-returned.png" alt="A bridge transfer returned on Android" />
  </Frame>
</div>
