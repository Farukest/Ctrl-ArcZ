...
export const tr: Record<TranslationKey, string> = {
  ...
  'cost.forwarding': '{chain} ağına aktarım',
  ...
  'common.switchTo': '{chain} ağına geç',
  'chain.needs.protectedSend': 'Korumalı gönderim {chain} ağında kullanılamıyor.',
  ...
  'nano.title': 'Kullandıkça öde',
  'nano.lead': 'Her istek, ajan cüzdanından Circle Nanopayments ile ödenir. Gaz yok, aylık fatura yok.',
  'nano.activate': 'Aktifleştir',
  'nano.left': 'Kalan bakiye',
  'nano.perRequest': 'İstek başı',
  'nano.requestsLeft': 'Kalan istek',
  'nano.spent': 'Harcanan',
  'nano.agent': 'Ajan cüzdanı',
  'nano.statusOk': 'Sağlıklı',
  'nano.statusWarn': 'Azalıyor',
  'nano.statusCritical': 'Kritik',
  'nano.statusEmpty': 'Boş',
  'nano.loadTitle': 'Bakiye yükle',
  'nano.load': "Gateway'e yükle",
  'nano.step.approve': 'USDC onayı',
  'nano.step.deposit': 'Ajan cüzdanına yatırma',
  'nano.step.credit': 'Circle bakiyeyi onaylıyor',
  'nano.loadedToast': 'Bakiye yüklendi.',
  'nano.accessTitle': "API'n",
  'nano.baseUrl': 'Base URL',
  'nano.apiKey': 'API anahtarı',
  'nano.tryPh': "Claude'a bir şey sor",
  'nano.try': 'Gönder',
  'nano.feedTitle': 'İstekler',
  'nano.feedEmpty': 'Henüz istek yok.',
  'nano.paidToast': 'Ödeme alındı · {amount}',
  'nano.tokens': '{in} giriş · {out} çıkış',
  'nano.circle.pending': 'Circle: bekliyor',
  'nano.circle.received': 'Circle: alındı',
  'nano.circle.batched': 'Circle: toplandı',
  'nano.circle.completed': 'Circle: zincirde',
  'nano.circle.failed': 'Circle: başarısız',
  'nano.withdraw': 'Kalanı geri çek',
  'nano.withdrawnToast': '{amount} cüzdanına gönderiliyor.',
  ...
  'bridge.gwstep.counted': "Circle'ın saymasını bekliyor...",
  ...
  'bridge.gwDepositWait': 'Buraya yatırılan tutar yaklaşık {wait} içinde sayılır.',
  ...
  // Zincir adlarina ek getirilmiyor: "Base Sepolia'dan" ile "Arc Testnet'ten"
  // farkli ek istiyor ve ekrandaki yanlis ek, eki hic koymamaktan kotu.
  'bridge.src.title': 'Ağlar',
  'bridge.src.spendable': 'Gönderilebilir',
  'bridge.src.count': '{n} ağ',
  'bridge.src.heldOn': "Gateway'de {amount} USDC",
  'bridge.src.ready': '{amount} USDC var',
  'bridge.src.legFee': 'ücret {fee} USDC',
  'bridge.src.hasAmount': '{amount} USDC',
  'bridge.src.auto': 'senin için bölündü',
  'bridge.src.pinned': 'senin girdiğin',
  'bridge.src.legAria': '{chain} ağından gidecek tutar',
  'bridge.src.short': 'Bu transfer için {amount} USDC eksik.',
  'bridge.src.overfill': 'Ağların toplamı gönderdiğinden {amount} USDC fazla.',
  'bridge.src.costlyNote': 'Bacaklardan biri Ethereum üzerinden, tek başına yaklaşık 1 USDC ücret.',
  'bridge.src.add': 'Ağ ekle',
  'bridge.src.totalFee': 'toplam ücret {fee} USDC',
  'bridge.src.stillShort': '{amount} eksik kalır',
  'bridge.src.tooSmall': 'kullanmak için çok az',
  'bridge.src.cover': 'Kalan {amount} {chain} ağından',
  'bridge.src.coverCostly': 'Kalan {amount} {chain} ağından, {fee} ücret',
  'bridge.src.topUp': '{amount} USDC yatır',
  'bridge.src.remove': '{chain} ağını kaldır',
  'bridge.src.overCapacity': '{chain} bunun {amount} kadarını gönderebilir',
  'bridge.src.raise': '{chain} {amount} daha taşıyabilir',
  'bridge.src.nothingHere': '{chain} üzerinde buna ayıracak bakiye yok',
  'bridge.src.costlyAsk': '{chain} ile tamamlamak {amount} USDC ücret demek',
  'bridge.src.costlyUse': '{chain} ile tamamla',
  'bridge.src.reduce': 'tutarı {amount} yap',
  'bridge.refusal.gwShort': 'Tüm zincirler toplamında {amount} USDC eksik, ücret dahil.',
  'bridge.refusal.gwStranded':
    'Gateway bakiyen {total} USDC ama her zincir kendi ücretini ödüyor. Karşı tarafa geçen {amount} USDC.',
  ...
  'bridge.gwOnChain': '{chain} üzerinde',
  ...
  'bridge.gwWalletOtherChain': 'Önce cüzdanın buraya geçer, sonra {wait} içinde sayılır.',
  'bridge.gwWalletUnreadable': 'Cüzdanın cevap vermedi. Tekrar deneniyor.',
  'bridge.gwNoGas': 'Burada gas ödeyecek {symbol} yok.',
  'bridge.gwDepositCta': 'Yatır',
  'bridge.gwDepositTooBig': 'Buradaki cüzdan bakiyenden fazla.',
  ...
  'bridge.gwPending': '{amount} yatırıldı, yaklaşık {wait} içinde sayılır.',
  ...
  'bridge.rowstep.counted': 'Circle saydı',
  ...
  'activity.feeIs': 'Ücret {fee} USDC',
  'activity.andMoreNetworks': '+{n} ağ daha',
  'activity.type': 'Tür',
  'activity.jump': 'İşleme git',
  'activity.steps': 'Adımlar',
  'activity.today': 'Bugün',
  'activity.yesterday': 'Dün',
  'activity.day': 'Tek bir günü göster',
  'activity.filter': 'Filtre',
  'activity.sortBy': 'Sırala',
  'activity.sort.newest': 'En yeni',
  ...
  'activity.v.subs': 'Abonelik',
  'activity.f.all': 'Tümü',
  'activity.f.undoable': 'Geri alınabilir',
  'activity.f.pending': 'Bekleyen',
  'activity.f.claimed': 'Alındı',
  'activity.f.refunded': 'İade',
  'activity.f.received': 'Gelen',
  'activity.f.sent': 'Giden',
  'activity.f.arrived': 'Ulaştı',
  'activity.f.failed': 'Bakılmalı',
  'activity.search.sent': 'No, tutar, adres',
  'activity.search.history': 'Adres, tutar, token',
  'activity.search.bridge': 'Zincir, tutar, işlem',
  'activity.search.subs': 'İsim, zincir, tutar',
  'activity.emptyIn.sent': 'Bu tarayıcıdan henüz korumalı transfer yapılmadı.',
  'activity.emptyIn.history': 'Bu cüzdanda henüz token transferi yok.',
  'activity.emptyIn.bridge': 'Bu tarayıcıdan henüz köprüleme yapılmadı.',
  'activity.emptyIn.subs': 'Bu tarayıcıdan henüz abonelik fonlanmadı.',
  'activity.from': 'Gönderen',
  'activity.to': 'Alıcı',
  'active.status.none': 'Okunamadı',
  ...
  'bridge.state.running': 'sürüyor',
  'bridge.state.stalled': 'yarıda kaldı',
  ...
  'risk.deepOff': 'Burada tanımlı değil, yalnızca kurallar',
  'risk.deepBudget': 'Günlük sınıra ulaşıldı, yalnızca kurallar',
  'risk.investigating': "Kuralların göremediğini agent'a soruyor...",
